...
urlpatterns = [
    ...
    path('chat/<str:identifier>/edit/<int:message_id>/', views.edit_message_direct, name='edit_message_direct'),
    ...
    path('group/<str:identifier>/edit/<int:message_id>/', views.edit_message_group, name='edit_message_group'),
