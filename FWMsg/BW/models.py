...
class ApplicationQuestion(OrgModel):
    ...
    choices = models.TextField(verbose_name='Auswahlmöglichkeiten', null=True, blank=True, help_text='Kommagetrennte Liste von Auswahlmöglichkeiten, die der Bewerber:in auswählen kann. Wenn leer, wird die Antwort als Textfeld angezeigt.')
